    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text('Items Summary', style: TextStyle(color: Colors.redAccent,fontStyle: FontStyle.italic,
          ...
          SizedBox(
            child: Row(
              ...
              children: [
                ...
                const Text('TOTAL', style: TextStyle(color: Colors.red,fontSize: 25),),

                // Display the calculated total price
                Text(finalPrice.toString(), style: const TextStyle(color: Colors.red,fontSize: 25),)
              ],
            ),
          )
        ],
